...
extern const RuntimeMethod* Enumerable_Average_m677900329_RuntimeMethod_var;
...
extern const uint32_t Enumerable_Average_m677900329_MetadataUsageId;
...
extern "C" IL2CPP_METHOD_ATTR float Enumerable_Average_m677900329 (RuntimeObject * __this /* static, unused */, RuntimeObject* ___source0, const RuntimeMethod* method)
{
	static bool s_Il2CppMethodInitialized;
	if (!s_Il2CppMethodInitialized)
	{
		il2cpp_codegen_initialize_method (Enumerable_Average_m677900329_MetadataUsageId);
		s_Il2CppMethodInitialized = true;
	}
	float V_0 = 0.0f;
	int64_t V_1 = 0;
	...
	NO_UNUSED_WARNING (__leave_target);
	{
		...
		NullCheck(L_1);
		RuntimeObject* L_2 = InterfaceFuncInvoker0< RuntimeObject* >::Invoke(0 /* System.Collections.Generic.IEnumerator`1<!0> System.Collections.Generic.IEnumerable`1<System.Single>::GetEnumerator() */, IEnumerable_1_t377119663_il2cpp_TypeInfo_var, L_1);
		V_3 = L_2;
	}
...
IL_001b:
		{
			...
			NullCheck(L_3);
			float L_4 = InterfaceFuncInvoker0< float >::Invoke(0 /* !0 System.Collections.Generic.IEnumerator`1<System.Single>::get_Current() */, IEnumerator_1_t1829837242_il2cpp_TypeInfo_var, L_3);
			V_2 = (((float)((float)L_4)));
			float L_5 = V_0;
			float L_6 = V_2;
...
IL_0047:
	...
	}
	{
		...
		IL2CPP_RAISE_MANAGED_EXCEPTION(L_13, NULL, Enumerable_Average_m677900329_RuntimeMethod_var);
	}
...
IL_0053:
	{
		float L_14 = V_0;
		int64_t L_15 = V_1;
		return ((float)((float)L_14/(float)(((float)((float)L_15)))));
	}
}
#ifdef __clang__
#pragma clang diagnostic pop
